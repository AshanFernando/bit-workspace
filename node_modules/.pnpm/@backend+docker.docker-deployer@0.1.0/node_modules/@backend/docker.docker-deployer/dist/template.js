...
export class NodeDockerFile {
    constructor() {
        this.name = "node";
        this.copyNodeModules = false;
    }
    async generate(opts) {
        ...
        const formattedCommand = this.getFormattedCommand(opts.entryFile, entryFileFn);
     ...
     */
    async getEntryFileFn(entryFile) {
        try {
    ...
    getFormattedCommand(entryFile, type) {
        if (type === "default") {
