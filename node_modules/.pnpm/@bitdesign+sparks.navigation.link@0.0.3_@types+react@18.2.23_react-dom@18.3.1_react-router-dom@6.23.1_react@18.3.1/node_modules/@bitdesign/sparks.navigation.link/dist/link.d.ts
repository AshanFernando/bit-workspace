...
import { LinkProps as BaseLinkProps } from '@teambit/base-react.navigation.link';
...
export declare function Link({ children, className, noStyle, ...rest }: LinkProps): import("react/jsx-runtime").JSX.Element;
