import { Spacing } from "@bitdesign/sparks.foundations.spacing";
import { ColorPalette, sparksColorPalette } from "@bitdesign/sparks.foundations.color-palette";
export function createTokens(context) {
    const palette = context?.colorPalette || ColorPalette.create(sparksColorPalette);
    const spacing = context?.spacing || Spacing.create();
    const tokens = {
