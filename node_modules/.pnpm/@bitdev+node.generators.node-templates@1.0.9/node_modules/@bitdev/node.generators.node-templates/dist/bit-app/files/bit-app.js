...
exports.bitAppFile = void 0;
const bitAppFile = (context) => {
    const { name, namePascalCase } = context;
    return {
        relativePath: `${name}.bit-app.ts`,
        content: `import { run${namePascalCase} } from './${name}.js';
 ...
 */
export class ${namePascalCase} implements Application {
  /**
 ...
 */    
export default new ${namePascalCase}();
`,
    };
};
exports.bitAppFile = bitAppFile;
//# sourceMappingURL=bit-app.js.map