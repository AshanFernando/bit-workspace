...
export class NodeApp implements Application {
  ...
  async build(context: AppBuildContext): Promise<AppBuildResult> {
    ...
    // TODO: pass all context.envVariables
    const result = await build({
      define: {
        'process.env.APP_NAME': `"${context.appName}"`,
        'process.env.APP_VERSION': `"${context.appComponent.id.version}"`,
        'process.env.LANE_ID': `"${context.laneId}"`,
      },
      ...this.esbuildOptions,
