...
const { generateStyleLoaders } = require('@teambit/webpack.modules.generate-style-loaders');
const { merge } = require('lodash');
const getLocalIdent = require('react-dev-utils-esm/getCSSModuleLocalIdent');
const stylesRegexps = require('@teambit/webpack.modules.style-regexps');
const postCssConfig = require('./post-css-config.cjs');
exports.createStyleLoaders = function (injectingLoader, options) {
...
//# sourceMappingURL=create-style-loaders.cjs.map