import { Application, ApplicationType, DeployFn } from "@teambit/application";
...
export class ReactSsrType implements ApplicationType<ReactSsrOptions> {
  name = 'react-ssr';
  
  createApp(options: ReactSsrOptions): Application {
    return new ReactSsr(
      options.name,
      options.filename,
      options.defaultPort,
