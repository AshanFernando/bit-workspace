...
export declare type ReactComponentTemplateOptions = Partial<Pick<ComponentTemplate, 'name' | 'description' | 'hidden' | 'env'>>;
export declare class ReactHookTemplate implements ComponentTemplate {
    ...
    constructor(name?: string, description?: string, hidden?: boolean, env?: string, installMissingDeps?: boolean);
