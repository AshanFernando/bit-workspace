...
function _reactGenerators2() {
  const data = require("@bitdev/react.generators.react-starters");
  _reactGenerators2 = function () {
    return data;
  };
  return data;
}
...
class ReactEnv {
   ...
   */
  starters() {
    return _generator().StarterList.from([_reactGenerators2().ReactWorkspaceStarter.from()]);
  }
   ...
   */
  generators() {
    return _generator().TemplateList.from([_reactGenerators().ReactComponentTemplate.from(), _reactGenerators().ReactViteTemplate.from(), _reactGenerators().ReactHookTemplate.from(), _reactGenerators().ReactWebpackTemplate.from(), _reactGenerators().ReactJSComponentTemplate.from(), _reactGenerators().ReactEnvTemplate.from(), _reactGenerators().ThemeTemplate.from()]);
  }
