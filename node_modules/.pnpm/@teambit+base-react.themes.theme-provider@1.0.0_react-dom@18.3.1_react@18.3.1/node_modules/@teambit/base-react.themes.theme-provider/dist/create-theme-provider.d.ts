...
export declare function createThemeProvider<T>(ThemeContext: React.Context<T>, options: CreateThemeOptions<T>): ({ children, overrides, style, ...rest }: ThemeProviderProps<T>) => React.JSX.Element;
