 ...
 * create a new theme.
 */
export declare function createTheme<T>({ theme, prefix, withoutCssVars }: CreateThemeOptions<T>): {
    ThemeProvider: ({ children, overrides, style, ...rest }: import("./create-theme-provider").ThemeProviderProps<T>) => React.JSX.Element;
    useTheme: () => T;
};
