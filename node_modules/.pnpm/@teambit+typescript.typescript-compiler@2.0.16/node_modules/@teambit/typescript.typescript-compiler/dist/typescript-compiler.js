...
class TypescriptCompiler {
    ...
    isFileSupported(filePath) {
        ...
        const isSupported = ((filePath.endsWith('.ts') ||
    ...
    // private getFilePathForTranspileFile(origFilePath: string): string {
    //   if (!this.options.esm) return origFilePath;
    //   const fileExtension = path.extname(origFilePath);
    //   if (fileExtension === '.js'){
