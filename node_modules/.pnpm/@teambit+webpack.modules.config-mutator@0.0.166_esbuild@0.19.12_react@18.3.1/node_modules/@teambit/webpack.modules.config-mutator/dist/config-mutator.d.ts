...
declare type ConflictPolicy = 'override' | 'error' | 'ignore';
declare type ArrayPosition = 'append' | 'prepend';
declare type AddKeyOpts = {
    conflictPolicy?: ConflictPolicy;
};
declare type AddToArrayOpts = {
    position?: ArrayPosition;
};
declare type MergeOpts = {
