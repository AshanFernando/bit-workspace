...
class WebpackConfigMutator {
    ...
    addElementToHtmlTemplate(element) {
        ...
        if (htmlPlugins) {
            ...
            htmlPlugins.forEach((htmlPlugin) => {
                var _a, _b, _c;
                const htmlContent = typeof ((_a = htmlPlugin.userOptions) === null || _a === void 0 ? void 0 : _a.templateContent) === 'function'
                    ? (_b = htmlPlugin.userOptions) === null || _b === void 0 ? void 0 : _b.templateContent({})
                    : (_c = htmlPlugin.userOptions) === null || _c === void 0 ? void 0 : _c.templateContent;
    ...
    removeElementFromHtmlTemplate(element) {
        ...
        if (htmlPlugin) {
            const htmlContent = typeof ((_c = htmlPlugin.userOptions) === null || _c === void 0 ? void 0 : _c.templateContent) === 'function'
                ? (_d = htmlPlugin.userOptions) === null || _d === void 0 ? void 0 : _d.templateContent({})
